...
// DO NOT return value, it will assume wrong type and overflow!
// simply output directly into cout
// OK: maybe return value, just specify output
auto solve (ld n, ld nth)
{
  // https://en.cppreference.com/w/cpp/numeric/math/pow
  // supports even infinite values the function std::pow
  // spent too much time thinking it would not...
  return (long double) std::pow(nth, 1.0L/n);
}
